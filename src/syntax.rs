...
impl<F: LurkField> fmt::Display for Term<F> {
...
pub fn parse_sym<F: LurkField>() -> impl Fn(Span) -> IResult<Span, Term<F>, ParseError<Span>> {
    move |from: Span| {
...
pub fn parse_str<F: LurkField>() -> impl Fn(Span) -> IResult<Span, Term<F>, ParseError<Span>> {
    move |i: Span| {
...
pub fn parse_num<F: LurkField>() -> impl Fn(Span) -> IResult<Span, Term<F>, ParseError<Span>> {
    move |i: Span| {
...
pub fn parse_dot_pair<F: LurkField>() -> impl Fn(Span) -> IResult<Span, Term<F>, ParseError<Span>> {
    move |i: Span| {
...
pub fn parse_list<F: LurkField>() -> impl Fn(Span) -> IResult<Span, Term<F>, ParseError<Span>> {
    move |i: Span| {
        let (i, _) = context("open paren", tag("("))(i)?;
        let mut i = i;
        let mut ts = Vec::new();
...
pub fn parse_quote<F: LurkField>() -> impl Fn(Span) -> IResult<Span, Term<F>, ParseError<Span>> {
    move |i: Span| {
...
pub fn parse_term<F: LurkField>() -> impl Fn(Span) -> IResult<Span, Term<F>, ParseError<Span>> {
    move |i: Span| {
        context(
            "term",
            alt((
...
pub mod tests {
    ...
    pub fn arbitrary_sym<F: LurkField>(g: &mut Gen) -> Term<F> {
    ...
    impl<F: LurkField> Arbitrary for Term<F> {
